            ...
            <table border="1">
                    ...
                    <?php foreach ($usuarios as $usuario): ?>
                        <tr>
                            ...
                            <td>
                                <a href="alterar_usuario.php?id=<?=$usuario['id_usuario']; ?>">Alterar</a> |
                                <a href="excluir_usuario.php?id=<?=$usuario['id_usuario']; ?>"onclick="return confirm('tem certeza que deseja excluir este usuario')">Excluir</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
            </table>
